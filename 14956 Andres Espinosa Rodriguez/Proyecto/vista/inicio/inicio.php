        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarColor01">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#">Ejemplo3</a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button"
                            aria-haspopup="true" aria-expanded="false">Lista</a>
    ...
    <div class="container p-5 my-5 text-white">
        <div class="card-group">
            <div class="card border" style="margin-right: 5px;">
                <center>
                    <img src="configuraciones/imagenes/user.jpg" style="width: 30%;" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Iniciar sesión Usuario</h5>
            ...
            <div class="card border">
                <center>
                    <img src="configuraciones/imagenes/admin.jpg" style="width: 30%;" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Iniciar sesión Admin</h5>
